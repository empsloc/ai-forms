...
function Upgrade() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    {PricingPlan.map((item:any,index:any)=>(
  ...
  <ul className="mt-6 space-y-2">
    <li className="flex items-center gap-1">
      ...
      <span className="text-gray-700"> {item.formsIncluded} forms included </span>
    </li>
    ...
    <li className="flex items-center gap-1">
      ...
      <span className="text-gray-700"> {item.storage}GB of storage </span>
    </li>
